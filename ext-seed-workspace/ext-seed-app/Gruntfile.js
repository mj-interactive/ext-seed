...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        'gh-pages': {
            options: {
                branch: 'gh-pages',
                base: '../build/production/ExtSeedApp'
            },
            publish: {
                options: {
                    repo: 'https://github.com/mj-interactive/ext-seed.git',
            ...
            deploy: {
                options: {
                    user: {
                        name: 'mj-interactive',
                        email: 'jie.li@mj-interactive.com'
                    },
                    repo: 'https://' + process.env.GH_TOKEN + '@github.com/mj-interactive/ext-seed.git',
